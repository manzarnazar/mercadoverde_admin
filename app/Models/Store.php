...
class Store extends Model
{
     ...
     * @var string[]
     */
    protected $appends = ['gst_status','gst_code','logo_full_url','cover_photo_full_url','meta_image_full_url','tin_certificate_image_full_url','cofepris_document_image_full_url'];
