...
(function () {
    ...
    function loadZoneMapDrawingScript(callback) {
        ...
        script.src = (window.baseUrl || "") + "/public/assets/admin/js/view-pages/zone-map-drawing.js?v=2";
        script.onload = callback;
        script.onerror = function () {
            console.error("Failed to load zone-map-drawing.js");
        };
    ...
    window.initialize = function () {
        loadZoneMapDrawingScript(bootstrapZoneMap);
    };

    window.__zoneMapV2 = true;

    // Maps API may finish before common.js when cached — bootstrap immediately if needed.
